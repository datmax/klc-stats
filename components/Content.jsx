...
export default function Content({ block, time }) {
  ...
  return (
    ...
    >
      <motion.div initial={{backgroundColor: "rgba(0, 0, 0, 0)"}} animate={{ backgroundColor: "rgba(0, 0, 0, 1)", transition:{duration:2}}} className="min-h-screen w-full bg-gradient-to-tr from-violet-800/30 via-black/20 to-black/20 bg-opacity-20">
